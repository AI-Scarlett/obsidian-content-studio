...
Desktop only. This branch: 0.1.10 preview build with browser assistant 0.3.3. Requires Obsidian 1.8.7 or later; earlier native validation used 1.13.7. Formatting preserves your source text and runs locally. No AI account, API key or automatic publishing is required.
...
The 0.1.10 preview bundles browser assistant 0.3.3, with platform-specific media and draft adapters. Existing unpacked extension installations must be reloaded once after updating their files. See [the release notes](docs/releases/0.1.10.md) and [browser assistant documentation](browser-extension/README.md) for current validation boundaries.
